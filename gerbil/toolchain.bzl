...
GerbilToolchainInfo = provider(
    ...
    fields = {
        ...
        "gerbil_gsc": "Gambit compiler launcher file",
        ...
        "runtime_api": "Gerbil runtime API family used by Scheme helpers",
...
def _gerbil_toolchain_impl(ctx):
    ...
    info = GerbilToolchainInfo(
        ...
        runtime_api = ctx.attr.runtime_api,
...
gerbil_toolchain = rule(
    ...
    attrs = {
        ...
        "runtime_api": attr.string(default = "legacy", values = ["legacy", "v19"]),
